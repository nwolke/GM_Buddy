...
- **Example**: `YOUR_COGNITO_CLIENT_ID`
- **Used in**: Frontend deployment
...
- `Cognito__UserPoolId` - Cognito user pool ID (e.g., `YOUR_COGNITO_USER_POOL_ID`)
- `Cognito__ClientId` - Cognito client ID (e.g., `YOUR_COGNITO_CLIENT_ID`)
